...
function atualizarUI() {
	...
	const elementoTarefaEmAndamento = document.querySelector(elementos.taskEmAndamnento) as HTMLParagraphElement;

	elementoTarefaEmAndamento!.textContent = estadoInicial.tarefaSelecionada ? estadoInicial.tarefaSelecionada.descricao : null;
